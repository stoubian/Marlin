...
#define CUSTOM_MACHINE_NAME "Ender-3 V2 11-10-23 Update"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  26.16,  26.16 }
    #define DEFAULT_Ki_LIST {   2.10,   2.10 }
    #define DEFAULT_Kd_LIST {  81.62,  81.62 }
  #else
    // Ender 3 v2
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 136.57 }
